...
interface StringIdentifierFactory extends IdentifierFactory
{
     ...
     *
     * @param non-empty-string $identifier The string representation of the identifier is specific to the type of
     *     identifier and implementation; for example, UUIDs use a specific format, while other identifiers may use
     *     other formats
     *
