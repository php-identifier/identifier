...
* GitHub Issues: <https://github.com/identifier/identifier/issues>
...
* identifier/identifier follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  identifier/identifier automatically runs tests for pull requests. However,
...
This project uses of [PHPStan](https://github.com/phpstan/phpstan) to provide
...
[github]: https://github.com/identifier/identifier
[issues]: https://github.com/identifier/identifier/issues
[pull requests]: https://github.com/identifier/identifier/pulls
